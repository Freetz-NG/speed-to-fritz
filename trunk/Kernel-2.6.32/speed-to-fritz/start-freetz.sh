...
#Kernel 2.6.32-->
  DO_COPY="y" # n is just for testing - uses the complet addon patch for freetz W722
    echo -e "\033[32mAlternative freetz trunk is used for Kernel 2.6.32 \033[0m"
    export FREETZ_DIR="freetz-trunk-2.6.32"
    FREETZ_DL_LINK="http://freetz.org/browser/branches/labor_preview"
#Kernel 2.6.32<--
