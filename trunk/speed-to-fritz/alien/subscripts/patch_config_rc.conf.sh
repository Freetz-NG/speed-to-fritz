...
[ "$CONFIG_KIDS" ] &&  sed -i -e "s/CONFIG_KIDS=\".*$/CONFIG_KIDS=\"${CONFIG_KIDS}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_DECT_AUDIOD" ] &&  sed -i -e "s/CONFIG_DECT_AUDIOD=\".*$/CONFIG_DECT_AUDIOD=\"${CONFIG_DECT_AUDIOD}\"/g" "${1}/etc/init.d/rc.conf"
...
[ "$CONFIG_KIDS_CONTENT" ] &&  sed -i -e "s/CONFIG_KIDS_CONTENT=\".*$/CONFIG_KIDS_CONTENT=\"${CONFIG_KIDS_CONTENT}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_IPV6" ] &&  sed -i -e "s/CONFIG_IPV6=\".*$/CONFIG_IPV6=\"${CONFIG_IPV6}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_DECT_CATIQ20" ] &&  sed -i -e "s/CONFIG_DECT_CATIQ20=\".*$/CONFIG_DECT_CATIQ20=\"${CONFIG_DECT_CATIQ20}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_EXT2" ] &&  sed -i -e "s/CONFIG_EXT2=\".*$/CONFIG_EXT2=\"${CONFIG_EXT2}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_MTD_MAILSEND" ] &&  sed -i -e "s/CONFIG_MTD_MAILSEND=\".*$/CONFIG_MTD_MAILSEND=\"${CONFIG_MTD_MAILSEND}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_USB_GSM_VOICE" ] &&  sed -i -e "s/CONFIG_USB_GSM_VOICE=\".*$/CONFIG_USB_GSM_VOICE=\"${CONFIG_USB_GSM_VOICE}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_RAMDISK" ] &&  sed -i -e "s/CONFIG_RAMDISK=\".*$/CONFIG_RAMDISK=\"${CONFIG_RAMDISK}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_DOCSIS_CLI" ] &&  sed -i -e "s/CONFIG_DOCSIS_CLI=\".*$/CONFIG_DOCSIS_CLI=\"${CONFIG_DOCSIS_CLI}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_DECT_NO_EMISSION" ] &&  sed -i -e "s/CONFIG_DECT_NO_EMISSION=\".*$/CONFIG_DECT_NO_EMISSION=\"${CONFIG_DECT_NO_EMISSION}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_DOCSIS" ] &&  sed -i -e "s/CONFIG_DOCSIS=\".*$/CONFIG_DOCSIS=\"${CONFIG_DOCSIS}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_NAS" ] &&  sed -i -e "s/CONFIG_NAS=\".*$/CONFIG_NAS=\"${CONFIG_NAS}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_EWETEL_SMARTMETER" ] &&  sed -i -e "s/CONFIG_EWETEL_SMARTMETER=\".*$/CONFIG_EWETEL_SMARTMETER=\"${CONFIG_EWETEL_SMARTMETER}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_WLAN_WEATHER_CAC" ] &&  sed -i -e "s/CONFIG_WLAN_WEATHER_CAC=\".*$/CONFIG_WLAN_WEATHER_CAC=\"${CONFIG_WLAN_WEATHER_CAC}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_WLAN_GUEST" ] &&  sed -i -e "s/CONFIG_WLAN_GUEST=\".*$/CONFIG_WLAN_GUEST=\"${CONFIG_WLAN_GUEST}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_SPEECH_FEEDBACK" ] &&  sed -i -e "s/CONFIG_SPEECH_FEEDBACK=\".*$/CONFIG_SPEECH_FEEDBACK=\"${CONFIG_SPEECH_FEEDBACK}\"/g" "${1}/etc/init.d/rc.conf"
[ "$CONFIG_DOCSIS_PCD_NO_REBOOT" ] &&  sed -i -e "s/CONFIG_DOCSIS_PCD_NO_REBOOT=\".*$/CONFIG_DOCSIS_PCD_NO_REBOOT=\"${CONFIG_DOCSIS_PCD_NO_REBOOT}\"/g" "${1}/etc/init.d/rc.conf"
