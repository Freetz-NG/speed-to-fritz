...
Section -CreateConfigFile
  ...
  FileWrite $0 "# This is a default config generated by the speedLinux installer.$\r$\n"
  ...
  FileWrite $0 "# If an other instance of tuntap is used, go to $INSTDIR/netdrivers and run 'addtap.bat' the second virtual adapter inside Windows will be named to 'TAPspeedLinux2'.$\r$\n"
  FileWrite $0 '#eth0=tuntap,"TAPspeedLinux2",$\r$\n'
  FileWrite $0 '#eth1=tuntap,"TAPspeedLinux2",$\r$\n'
  FileWrite $0 "$\r$\n"
...
#  CreateDirectory "$SMPROGRAMS\speedLinux\Non-Service"
  ...
  CreateShortCut "$SMPROGRAMS\speedLinux\Service\XmingStart.lnk" "$INSTDIR\Xming\Xming.exe" ":0 -dpi 85 -clipboard -notrayicon -c -multiwindow -reset -terminate -unixkill -logfile Xming.log" ""
  CreateShortCut "$SMPROGRAMS\speedLinux\Service\XmingStartRootless.lnk" "$INSTDIR\Xming\Xming.exe" ":0 -dpi 85 -clipboard -rootless -notrayicon -c -multiwindow -reset -terminate -unixkill -logfile Xming.log" ""
