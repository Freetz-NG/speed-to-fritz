...
*               The XSVF data is retrieved by readByte().

*               Remove the main function if you already have one. REMOVED!
*		Nothig else changed.
...
*               v4.05.01- Added support for defining dynamic device targets.
...
*               v5.01.03 - Fix trailer shift sequence in xsvfShift.
*****************************************************************************/
...
/*****************************************************************************
/* if used, playerfile has to be prepered with fopen */
FILE *in;
