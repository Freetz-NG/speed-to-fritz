...
//  Version 4.9 to 5.1 by johann.pascher at gmail.com
// **************************************************************************
//
...
void chip_detect(void)
{
    ...
    else
    {
	    ...
	    printf("    1) WRT54G/GS/AVM/Speedport is not Connected.\n");
	    printf("    2) WRT54G/GS/AVM/Speedport is not Powered On.\n");
...
void show_usage(void)
{
   ...
   printf( " NOTES: 1) If 'flashing' - the source filename must exist as follows:\n"
	   ...
	   " .............................................................................................\n"
	   "hir        Header Instruction    The number of (one) bits to shift before the target set of\n"
	   "           Register              instruction bits. These bits put the non-target devices\n"
	   "                                 after the target device into BYPASS mode.\n"
	   ...
	   "tir        Trailer Instruction   The number of (one) bits to shift after the target set of\n"
	   "           Register              instruction bits. These bits put the non-target devices\n"
	   "                                 before the target device into BYPASS mode.\n"
	   "                                 The 'tir' value must be equivalent to the sum of\n"
	   "                                 instruction register lengths for devices preceding the\n"
	   "                                 target device in the scan chain.\n"
	   "hdr        Header Data Register  The number of (zero) bits to shift before the target set of\n"
	   "                                 data bits. These bits are placeholders that fill the\n"
	   ...
	   "tdr        Trailer Data Register The number of (zero) bits to shift after the target set of\n"
	   "                                 data bits. These bits are placeholders that fill the\n"
...
int main(int argc, char** argv)
{
    ...
    printf("\n");
    printf("==================================================\n");
    printf("WRT54G/GS/AVM/Speedport EJTAG Debrick Utility v5.1\n");
    printf("==================================================\n");
    if (argc < 2)
    {
        show_usage();
