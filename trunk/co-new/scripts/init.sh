...
do
 mknod /freetz-colinux-setup$type/dev/cobd$i b 117 $i 2> /dev/null
done
echo " * Initializing swap file: /dev/${CL_SWAP}"
#swapoff /freetz-colinux-setup$type/dev/${CL_SWAP}
mkswap /freetz-colinux-setup$type/dev/${CL_SWAP}
#swapon /freetz-colinux-setup$type/dev/${CL_SWAP}
